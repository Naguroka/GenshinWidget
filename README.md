...
4. **Grab Game UID**: Go to Genshin Impact or your Hoyolab Battle Chronicle to get your in game UID to fill out the `tuid_v2` feild in the `settings.ini` -> `[Auth]` section.
